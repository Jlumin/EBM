...
def main(is_download_file_function=False, download_drive_service_name=None, download_file_path=None, drive_service_folder_name=None):
    ...
    if is_download_file_function is True:
        ...
        i=0
        for i in range(len(getDownloadFileIdList)):
            delete_drive_service_file(service=service, file_id=getDownloadFileIdList[i])
            print(getDownloadFileNameList[i])
if __name__ == '__main__':
    main(is_download_file_function=bool(True), drive_service_folder_name='test_upload', download_drive_service_name=None, download_file_path=os.getcwd() + '/test_folder/')
