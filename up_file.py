...
def main(is_update_file_function=False, update_drive_service_folder_name=None, update_drive_service_name=None, update_file_path=None):
    ...
    if is_update_file_function is True:
        ...
        update_file(service=service, update_drive_service_name=update_drive_service_name,
                    local_file_path=os.getcwd() + '/test_data/' + update_drive_service_name, update_drive_service_folder_id=get_folder_id)
        print("=====上傳檔案完成=====")


if __name__ == '__main__':
    dataPath='/home/pi/EBM/'
    ...
    for i in range(len(allFileList)):
        ...
        main(is_update_file_function=bool(True), update_drive_service_folder_name='test_upload', update_drive_service_name=allFileList[i], update_file_path=os.getcwd() + '/test_data/')
