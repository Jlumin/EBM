# -*- coding: utf-8 -*-
"""
Created on Wed Jun 24 00:39:04 2020
    ...
    if is_update_file_function is True:
       ...
       # print("=====執行上傳檔案=====")
        ...
        update_file(service=service, update_drive_service_name=update_drive_service_name,
                    local_file_path=os.getcwd() + '/EBM/test_data/' + update_drive_service_name, update_drive_service_folder_id=get_folder_id)
        #print("=====上傳檔案完成=====")


if __name__ == '__main__':
    dataPath='/home/pi/EBM/test_data/'
    ...
    for i in range(len(allFileList)):
       filepath = allFileList[i]
       main(is_update_file_function=bool(True), update_drive_service_folder_name='test_upload', update_drive_service_name=allFileList[i], update_file_path=os.getcwd() + '/')
       os.remove(dataPath+filepath)
           #print("完成")
